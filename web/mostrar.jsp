<%-- 
    Document   : mostrar
    Created on : 22/05/2020, 01:20:48 PM
    Author     : Isaac
--%>
...
<html>
    ...
    <body background="https://static.vecteezy.com/system/resources/previews/000/692/417/non_2x/white-and-gray-brick-perspective-with-shadow-vector.jpg">
        ...
        <div class="shadow p-3 mb-5 bg-white rounded" style="width: 2200px; height: px;">
            <table class="table ">
                <tr>
...
<!--                    <td>
                        <a href="editar.jsp?id=<%= rs.getString(1)%>" class="btn-warning btn-sm">Editar</a>
